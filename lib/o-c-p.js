...
export default {
  ...
  **/
  ...
  /**
    function consumeBusy(registry)
    function to get the registry from the busy module
    @param registry Object
    the registry of the busy module
    @return Disposable
    the disposable for the registry
  **/
